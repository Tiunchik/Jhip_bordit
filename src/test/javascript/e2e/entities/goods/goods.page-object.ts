...
export default class GoodsComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('goods-heading'));
...
export class GoodsDeleteDialog {
  ...
  title: ElementFinder = element(by.id('borditApp.goods.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-goods'));
}
