...
describe('Category e2e test', () => {
  ...
  describe('Create flow', () => {
    it('should load create Category page', async () => {
      ...
      expect(await updatePage.title.getText()).to.match(/Create or edit a Category/);
    });
    ...
    describe('Details, Update, Delete flow', () => {
      after(async () => {
        ...
        expect(await deleteDialog.title.getAttribute('id')).to.match(/borditApp.category.delete.question/);
