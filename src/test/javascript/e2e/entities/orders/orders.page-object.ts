...
export default class OrdersComponentsPage extends AlertPage {
...
export class OrdersDeleteDialog {
  ...
  title: ElementFinder = element(by.id('borditApp.orders.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-orders'));
}
