...
import ru.bordit.config.audit.AuditEventConverter;
import ru.bordit.domain.PersistentAuditEvent;
...
import static ru.bordit.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
